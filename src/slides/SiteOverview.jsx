...
function OverallPerformance({ onCompleteOverviewClick }) {
  ...
  const improvements = categories.map(cat => {
    if (cat === 'Deviation') {
      return 0 // Placeholder for Deviation data
    }
    let sum = 0, count = 0
  ...
  const categoryDetails = {
    ...
    'Deviation': {
      ...
      calculation: 'Data to be added',
      sites: [],
      description: 'Deviation metrics and improvements'
    }
  };
          ...
          <div key={cat} style={{ textAlign: 'center', position: 'relative' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                backgroundColor: improvement < 0 ? '#ef4444' : categoryColors[cat],
                borderRadius: '4px',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
      ...
      {Object.entries(sitesData)
        ...
        return (
          ...
          >
            ...
            <div style={{ marginTop: '12px', paddingTop: '12px', borderTop: `1px solid ${siteColors[site]}30` }}>
              <button
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
