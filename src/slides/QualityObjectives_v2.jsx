        ...
        >
          ...
          >
            <div style={{
              ...
              <div>
                <div style={{ fontSize: '1.2rem', color: '#0f172a', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '4px' }}>
                  Objective 07 • QI 3
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
                      ...
                      <span style={{ fontSize: '1.7rem', color: '#0f172a', fontWeight: 700 }}>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', background: '#ffffff' }}>
                      ...
                      <tbody>
                        ...
                        <tr style={{ background: '#ffffff', borderBottom: '1px solid #e2e8f0' }}>
                          ...
                          <td style={{ padding: '14px 16px', fontSize: '0.95rem', color: '#475569', borderRight: '1px solid #e2e8f0' }}>30/12/2025</td>
                          <td style={{ padding: '14px 16px', fontSize: '0.95rem', fontWeight: 700, color: '#0f172a', borderRight: '1px solid #e2e8f0' }}>Not started</td>
                          <td style={{ padding: '14px 16px', fontSize: '0.95rem', fontWeight: 700, color: '#ef4444' }}>Delay</td>
                        </tr>
                        <tr style={{ background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
