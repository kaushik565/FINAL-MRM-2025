    ...
    <div style={{ marginTop: '20px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', marginBottom: '32px' }}>
        <div style={{
          ...
          <div style={{ fontSize: '0.75em', color: '#0f172a', marginTop: '4px' }}>Across Apr-Nov</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.75em', color: '#0f172a', marginTop: '4px' }}>Closure rate {closureRate}%</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.75em', color: '#0f172a', marginTop: '4px' }}>Across closed items</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.75em', color: '#0f172a', marginTop: '4px' }}>{improvementPct}% faster vs baseline</div>
        </div>
      </div>
