    ...
    <div style={{ marginTop: '20px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '32px' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.75em', color: '#0f172a', marginTop: '4px' }}>20 → 17 days</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.75em', color: '#0f172a', marginTop: '4px' }}>{janAugAvgInvestigation} → {sepNovAvgInvestigation} days</div>
