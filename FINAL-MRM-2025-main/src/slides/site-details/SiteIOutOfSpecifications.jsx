    ...
    <div style={{ marginTop: '20px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', marginBottom: '32px' }}>
        <div style={{
          ...
          <div style={{ fontSize: '0.75em', color: '#0f172a', marginTop: '4px' }}>Apr-Nov 2025</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.75em', color: '#0f172a', marginTop: '4px' }}>Closed {totalClosed} of {totalRecords}</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.75em', color: '#0f172a', marginTop: '4px' }}>Improved {improvementPct}% vs baseline</div>
        </div>
      </div>
