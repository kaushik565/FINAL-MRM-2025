    ...
    <div style={{ marginTop: '20px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', marginBottom: '32px' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.75em', color: '#0f172a', marginTop: '4px' }}>Jan-Jun baseline</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.75em', color: '#0f172a', marginTop: '4px' }}>Closed {closed.reduce((a, b) => a + b, 0)} of {totalRecords}</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.75em', color: '#0f172a', marginTop: '4px' }}>Jul-Nov vs Jan-Jun</div>
        </div>
      </div>
