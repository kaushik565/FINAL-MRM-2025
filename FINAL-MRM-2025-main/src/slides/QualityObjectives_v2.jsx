  ...
  const obj05_qi1Data = [
    {
      ...
      infoRows: [
        { srNo: 1, product: 'TRUENAT', processStep: 'Chip Arrangements', gap: '1) No IPQA check on chip type 2) Quick rejection is not getting to new worker during sorting of chips', implementation: '1) Include IPQA verification to confirm correct chip type 2) Need to make pictorial representations on workstations of different types of rejection', training: 'Completed', status: 'Completed' },
        { srNo: 2, product: 'TRUENAT', processStep: 'Chip washing', gap: 'No IPQA check for chip washing activity', implementation: 'Include IPQA verification', training: 'Completed', status: 'Completed' },
        { srNo: 3, product: 'TRUENAT', processStep: 'MG Filling', gap: 'NA', implementation: 'Include IPQA verification', training: 'Completed', status: 'Completed' },
        { srNo: 4, product: 'TRUENAT', processStep: 'Master Mix Filling', gap: 'No IPQA verification', implementation: 'Include IPQA verification', training: 'Completed', status: 'Completed' },
        { srNo: 5, product: 'TRUENAT', processStep: 'Tube Sorting', gap: 'No IPQA verification', implementation: 'Include IPQA verification', training: 'Completed', status: 'Completed' },
        { srNo: 6, product: 'TRUENAT', processStep: 'Polymer Dispensing', gap: 'As per SOP/MC/005 chips shall be used for 120 hrs but track for the same is not there.', implementation: 'Label introduced', training: 'Completed', status: 'Completed' },
        { srNo: 7, product: 'TRUEPREP', processStep: 'Buffer filling', gap: 'No volume verification check during the filling process', implementation: 'Volume verification check has been implemented', training: 'Completed', status: 'In progress' },
        { srNo: 8, product: 'TRUEPREP', processStep: 'Reagent Preparation', gap: 'Before approval of buffer labels are sent for vendor for printing purpose like wash buffers.', implementation: 'After approval of the Buffer, Labels should be sent for Printing or hold the Reagent pack assembly at store and after approval of all the three buffers assembly can be released in production', training: 'In progress', status: 'In progress' },
        { srNo: 9, product: 'TRUEPREP', processStep: 'Washing Process', gap: 'Washing of bungs, Beads is carried out for 10 ml PP bottles, however there is no washing procedure for bottles', implementation: 'Dust particles were observed on bottles in final packing. Washing of bottles should be implemented in the process or it must be pre-sterilised by the vendor', training: 'In progress', status: 'In progress' },
        { srNo: 10, product: 'TRUEPREP', processStep: 'Buffer filling', gap: 'No volume verification check during the filling process', implementation: 'Volume verification check has been implemented', training: 'Completed', status: 'In progress' },
        { srNo: 11, product: 'TRUEPREP', processStep: 'AUTO v2 Packing', gap: 'Leakages observed in the Assemblies after Reagent packing or during final packing stage', implementation: 'In process testing of AUTO v2 Reagent pack will help to reduce the risk either at Buffer filling or AUTO v2 packing stage', training: 'In progress', status: 'In progress' },
        { srNo: 12, product: 'TRUEPREP', processStep: 'Cartridge Pouching', gap: 'No Dye leak testing in Cartridge pouching section', implementation: 'It should be implemented as in process check to check any leakages in the cartridges', training: 'In progress', status: 'In progress' },
        { srNo: 13, product: 'TRUEPREP', processStep: 'Cartridge packing', gap: 'Extra Cartridges and Reagent Pack transferred to Site IV, there is no traceability in terms of documents neither reflects in Batch Records.', implementation: 'Need to have traceability of the same and which will reflect in APQR. But it is transferred through SAP as STO order', training: 'In progress', status: 'In progress' }
      ]
    },
    {
      site: 'Site III',
  ...
  const obj05_qi2Data = [
    {
      ...
      infoRows: [
        ...
        { slNo: 4, sopNumber: 'NA', sopName: 'Problem solving Skills', trainer: 'Hameed CR', trainingDate: '21-11-2025', status: 'Completed' },
        { slNo: 5, sopNumber: 'NA', sopName: 'Training on effective investigation', trainer: 'Hameed CR', trainingDate: '21-11-2025', status: 'Completed' },
        { slNo: 6, sopNumber: 'SOP/MA/002', sopName: 'Risk management', trainer: 'Hameed CR', trainingDate: '15-12-2025', status: 'Inprogress' },
        { slNo: 7, sopNumber: 'NA', sopName: 'Crtical Process SOPs identified in QI01', trainer: 'NA', trainingDate: 'Yet to Plan', status: 'Inprogress' }
      ]
    },
    {
      site: 'Site III',
      ...
      infoRows: [
        ...
        { slNo: 2, sopNumber: 'NA', sopName: 'RCA tools', trainer: 'Hameed CR', trainingDate: '13/11/2025', status: 'Completed' },
        { slNo: 3, sopNumber: 'NA', sopName: 'Problem sloving Skills', trainer: 'Hameed CR', trainingDate: '21/11/2025', status: 'Completed' },
        { slNo: 4, sopNumber: 'NA', sopName: 'Training on effective investigation', trainer: 'Hameed CR', trainingDate: '21/11/2025', status: 'Completed' },
        { slNo: 5, sopNumber: 'SOP/MA/002', sopName: 'Risk management', trainer: 'Hameed CR', trainingDate: '15/12/2025', status: 'Inprogress' },
        { slNo: 6, sopNumber: 'SOP/SD/III/001R', sopName: 'Procedure for mono block manifold assembly and functionality testing for assembly of extraction device.', trainer: 'Jangam Anil Kumar', trainingDate: '31/12/2025', status: 'Inprogress' },
        { slNo: 7, sopNumber: 'STP/MD/III/001', sopName: 'Heater testing and Testing procedure for assembly of extraction device', trainer: 'Jangam Anil Kumar', trainingDate: '31/12/2025', status: 'Inprogress' },
        { slNo: 8, sopNumber: 'SOP/SD/III/002', sopName: 'Procedure of Mechanical Sub Assembly for Assembly of extraction Device', trainer: 'Jangam Anil Kumar', trainingDate: '31/12/2025', status: 'Inprogress' },
        { slNo: 9, sopNumber: 'SOP/MD/III/003', sopName: 'Procedure from Top Cover Assembly to Case Closing And Labelling Assembly of Assembly of Extraction Device', trainer: 'Jangam Anil Kumar', trainingDate: '31/12/2025', status: 'Inprogress' },
        { slNo: 10, sopNumber: 'SOP/MD/III/013', sopName: 'Assembly procedure Bottom Cover Assembly to Final Assembly for Assembly of Four Bay PCR Machine', trainer: 'Jangam Anil Kumar', trainingDate: '31/12/2025', status: 'Inprogress' },
        { slNo: 11, sopNumber: 'SOP/MD/III/013', sopName: 'Assembly procedure Bottom Cover Assembly to Final Assembly for Assembly of Four Bay PCR Machine', trainer: 'Jangam Anil Kumar', trainingDate: '31/12/2025', status: 'Inprogress' },
        { slNo: 12, sopNumber: 'STP/MD/III/003', sopName: 'Testing procedure for Assembly of Four Bay and Two Bay PCR Machine', trainer: 'Jangam Anil Kumar', trainingDate: '31/12/2025', status: 'Inprogress' },
        { slNo: 13, sopNumber: 'SOP/CA/III/052', sopName: 'Procedure for Operating cartridge Laser Welding Machine', trainer: 'Ramya', trainingDate: '31/12/2025', status: 'Inprogress' },
        { slNo: 14, sopNumber: 'SOP/CA/III/059', sopName: 'Process flow and operational procedure for cartridge production of an automation line', trainer: 'Ramya', trainingDate: '31/12/2025', status: 'Inprogress' },
        { slNo: 15, sopNumber: 'SOP/CA/III/041', sopName: 'PROCESS FLOW OF LASER CARTRIDGE PRODUCTION', trainer: 'Ramya', trainingDate: '31/12/2025', status: 'Inprogress' }
      ]
    },
    {
      site: 'Site V',
  ...
  const renderSiteCards = (data, colors) => {
    ...
    if (isObj07QI2) {
      return (
        <>
          ...
          {obj07Qi2InfoModal && createPortal(
            <FullscreenShell onClose={() => {
    ...
    if (isObj05QI1) {
      return (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', marginTop: '24px' }}>
          {data.map((item, idx) => {
            const isInfoOpen = obj05Qi1InfoSite === item.site;
            const hasInfoData = item.infoRows && item.infoRows.length > 0;
                ...
                <div style={{ 
                  ...
                  {hasInfoData && (
                    <button
                      ...
                      onMouseLeave={(e) => {
                        e.currentTarget.style.background = isInfoOpen ? `${colors.primary}15` : '#ffffff';
                        e.currentTarget.style.transform = 'scale(1)';
                      }}
                      aria-label="Show gap assessment details"
                    >
                      i
                    </button>
                  )}
          ...
          {obj05Qi1ActivitiesModal && createPortal(
            <FullscreenShell onClose={() => setObj05Qi1ActivitiesModal(null)}>
              <div
                style={{
                  width: '100%',
                  height: '100%',
          ...
          {obj05Qi1InfoModal && createPortal(
            <FullscreenShell onClose={() => {
              ...
              >
                ...
                <div style={{ 
                  ...
                  {/* Check if data has srNo (Site I/V format) or process (Site III format) */}
                  {obj05Qi1InfoModal.rows[0]?.srNo ? (
                    /* Site I and Site V Format - Gap Assessment Table */
                    <div style={{
                      background: '#ffffff',
                      borderRadius: '14px',
                      border: '2px solid #3b82f6',
                      ...
                      <div style={{ overflowX: 'auto' }}>
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                          ...
                          <tbody>
                            {obj05Qi1InfoModal.rows.map((row, idx) => (
                              <tr 
                                key={idx}
                                style={{
                    ...
                    /* Site III Format - Process Mapping */
                    <>
                      {/* Stats Banner */}
                      <div style={{
                        display: 'grid',
                      ...
                      {/* Process Groups as Compact Table */}
                      {(() => {
                        const processGroups = {};
                        ...
                        const groupColors = [
                          { bg: '#dbeafe', border: '#3b82f6', text: '#1e40af', icon: '🔧' },
                          { bg: '#dcfce7', border: '#10b981', text: '#065f46', icon: '⚡' }
                        ];
                              ...
                              <tbody>
                                {items.map((item, itemIdx) => (
                                  ...
                                  >
                                    ...
                                    <td style={{ padding: '14px 20px', fontSize: '1.15rem', fontWeight: 700, color: colorScheme.text }}>
                                      {item.product}
                                    </td>
                                    <td style={{ padding: '14px 20px' }}>
                                      <div style={{ 
                                        ...
                                        <span style={{ color: colorScheme.border, fontSize: '1rem' }}>▸</span>
                                        {item.stage}
                                      </div>
                                    </td>
                                  </tr>
      ...
      return (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', marginTop: '24px' }}>
          {data.map((item, idx) => {
            ...
            const isInfoOpen = obj05Qi2InfoSite === item.site;
            const hasInfoData = item.infoRows && item.infoRows.length > 0;
        ...
        {obj05Qi2InfoModal && createPortal(
          <FullscreenShell onClose={() => {
                  ...
                  <table style={{
                    ...
                    <tbody>
                      {obj05Qi2InfoModal.rows.map((row, idx) => {
                        ...
                        const statusColor = row.status === 'Completed' ? '#10b981' : '#f59e0b';
                        const statusBg = row.status === 'Completed' ? '#d1fae5' : '#fef3c7';
                        ...
                        return (
                          <tr
                            ...
                            onMouseLeave={(e) => {
                              e.currentTarget.style.background = isEven ? '#f8fafc' : '#ffffff';
                              e.currentTarget.style.transform = 'scale(1)';
                            }}
                          >
  ...
  return (
    <section data-state="quality-objectives" style={{ padding: '60px 24px', background: 'linear-gradient(135deg, #f0f9ff 0%, #f5f3ff 25%, #fef3c7 50%, #fef2f2 75%, #f0f9ff 100%)', position: 'relative', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', boxSizing: 'border-box', overflow: 'visible' }}>
      ...
      <div style={{ maxWidth: '1400px', width: '100%', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '28px', position: 'relative', zIndex: 1 }}>
        ...
        {activeModals.card && createPortal(
          <FullscreenShell onClose={() => setActiveModals({ card: null, qi04: null, qi05: null, qi06: null, qi07: null })}>
            <div style={{
              width: '100%',
              height: '100%',
              overflow: 'auto',
            ...
            {activeModals.card === '04' && (
              <>
                ...
                {/* QI Buttons */}
                <div style={{ display: 'flex', gap: '18px', marginBottom: '28px', flexWrap: 'nowrap', alignItems: 'center', justifyContent: 'center' }}>
