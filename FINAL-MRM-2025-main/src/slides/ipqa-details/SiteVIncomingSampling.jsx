      ...
      <div style={{
        ...
        {[
          ...
          <div key={idx} style={{
            ...
            <div style={{ fontSize: '0.85em', color: '#0f172a', fontWeight: '600', marginBottom: '4px' }}>
              {metric.label}
            </div>
            ...
            {categoryData.map((cat, idx) => (
              <div key={idx} style={{
                ...
                <div style={{
                  ...
                  fontSize: '0.75em',
                  fontWeight: '600',
                  color: cat.status === 'Excellent' ? '#22c55e' : '#0f172a',
                  textAlign: 'right'
                }}>
                  Status: {cat.status}
                </div>
          ...
          <tbody>
            {testTypes.map((test, idx) => (
              ...
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'white'}>
                ...
                <td style={{ padding: '14px', textAlign: 'center', fontSize: '0.9em', fontWeight: '600', color: '#0f172a' }}>
                  {test.avgTime}
                </td>
