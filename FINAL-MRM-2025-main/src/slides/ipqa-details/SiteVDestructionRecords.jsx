  ...
  return (
    <section style={{
      ...
      <div style={{ marginBottom: '30px' }}>
        ...
        <p style={{ fontSize: '1.1em', color: '#0f172a', fontWeight: '500' }}>
      ...
      <div style={{
        ...
        {[
          ...
          <div key={idx} style={{
            ...
            <div style={{ fontSize: '0.8em', color: '#0f172a', fontWeight: '600', marginBottom: '4px' }}>
              {metric.label}
            </div>
            ...
            {monthlyData.map((data, idx) => (
              <div key={idx}>
                <div style={{
                  ...
                  <span style={{ fontSize: '0.85em', fontWeight: '600', color: '#0f172a' }}>
              ...
              {destructionMethods.map((method, idx) => (
                <tr key={idx} style={{ borderBottom: '1px solid #e2e8f0' }}
                  ...
                  <td style={{ padding: '12px' }}>
                    ...
                    <div style={{ fontSize: '0.7em', color: '#0f172a', fontWeight: '600' }}>
                      {method.vendor}
                    </div>
                  </td>
                  ...
                  <td style={{ padding: '12px', textAlign: 'center', fontSize: '0.85em', fontWeight: '600', color: '#0f172a' }}>
                    {method.percentage}%
                  </td>
