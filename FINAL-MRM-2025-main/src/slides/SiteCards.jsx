      ...
      <div className="slide-content" style={{ padding: '32px 40px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px', gap: '16px' }}>
          <div>
            ...
            <p style={{ margin: 0, color: '#0f172a', maxWidth: '720px', fontSize: '0.95em' }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '16px', marginBottom: '12px' }}>
              <div>
                ...
                <p style={{ margin: 0, color: '#0f172a', maxWidth: '600px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '12px' }}>
              {categories.map(cat => (
                ...
                >
                  ...
                  <div style={{ fontSize: '0.78em', color: '#0f172a', marginTop: '6px' }}>Tap to proceed</div>
                </button>
              ))}
            </div>
