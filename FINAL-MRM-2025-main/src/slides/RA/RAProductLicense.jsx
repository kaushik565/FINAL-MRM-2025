        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              background: activeTab === tab.id ? 'linear-gradient(135deg, #3b82f6, #2563eb)' : '#ffffff',
              color: activeTab === tab.id ? '#ffffff' : '#64748b',
              boxShadow: activeTab === tab.id ? '0 4px 15px rgba(59, 130, 246, 0.3)' : '0 2px 8px rgba(0, 0, 0, 0.1)'
            }}
          >
            {tab.label}
          </button>
      ...
      {activeTab === 'overview' && (
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '1.8em', fontWeight: '900', margin: '0 0 10px 0' }}>Approved</h3>
            <div style={{
              width: '60px',
              height: '60px',
              margin: '10px auto',
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '1.8em', fontWeight: '900', margin: '0 0 10px 0' }}>Submitted</h3>
            <div style={{
              width: '60px',
              height: '60px',
              margin: '10px auto',
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '1.8em', fontWeight: '900', margin: '0 0 10px 0' }}>Inprocess</h3>
            <div style={{
              width: '60px',
              height: '60px',
              margin: '10px auto',
          ...
          {[
            ...
            <>
              <div style={{
                background: row.key === 'total' ? 'linear-gradient(135deg, #3b82f6, #2563eb)' : '#ffffff',
                borderRadius: '12px',
                padding: '15px 20px',
                display: 'flex',
                alignItems: 'center',
              ...
              {['approved', 'submitted', 'inprocess'].map(status => (
                ...
                >
                  <div style={{ fontSize: '0.9em', color: '#64748b', fontWeight: '600', marginBottom: '8px' }}>
                    Site I - <span style={{ fontSize: '1.6em', color: '#0f172a', fontWeight: '900' }}>
                      {licenseData[status][row.key].siteI || 'NA'}
                    </span> products
                  </div>
                  <div style={{ fontSize: '0.9em', color: '#64748b', fontWeight: '600' }}>
                    Site V - <span style={{ fontSize: '1.6em', color: '#0f172a', fontWeight: '900' }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <div style={{ fontSize: '1.2em', color: '#3b82f6', fontWeight: '700', marginBottom: '5px' }}>TEST LICENSE</div>
                <div style={{ fontSize: '0.9em', color: '#64748b' }}>Query responded: <strong>08</strong> | Under query: <strong>03</strong></div>
              </div>
              <div style={{
                width: '120px',
                height: '120px',
              ...
              <div>
                <div style={{ fontSize: '1.2em', color: '#f59e0b', fontWeight: '700', marginBottom: '5px' }}>MANUFACTURING LICENSE</div>
                <div style={{ fontSize: '0.9em', color: '#64748b' }}>Query responded: <strong>55</strong> | Under query: <strong>01</strong></div>
              </div>
            </div>
            <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '15px' }}>
              <div>
                <div style={{ fontSize: '1.1em', color: '#14b8a6', fontWeight: '700' }}>CONDITION FULFILLMENT</div>
                <div style={{ fontSize: '0.9em', color: '#64748b' }}>Query responded: <strong>09</strong> | Under query: <strong>06</strong></div>
              </div>
              <div>
                <div style={{ fontSize: '1.1em', color: '#06b6d4', fontWeight: '700' }}>CLINICAL INVESTIGATION</div>
                <div style={{ fontSize: '0.9em', color: '#64748b' }}>Query responded: <strong>01</strong></div>
              </div>
            </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ background: 'linear-gradient(135deg, #3b82f6, #2563eb)', color: '#ffffff' }}>
                  <th style={{ padding: '15px', textAlign: 'left', fontWeight: '700', fontSize: '1em' }}>Sr. No.</th>
                  <th style={{ padding: '15px', textAlign: 'left', fontWeight: '700', fontSize: '1em' }}>Type of license</th>
                  <th style={{ padding: '15px', textAlign: 'left', fontWeight: '700', fontSize: '1em' }}>Product Name</th>
                  <th style={{ padding: '15px', textAlign: 'left', fontWeight: '700', fontSize: '1em' }}>Site</th>
                  <th style={{ padding: '15px', textAlign: 'left', fontWeight: '700', fontSize: '1em' }}>Status</th>
                </tr>
              </thead>
              <tbody>
                {inprocessDetails.flatMap((item, idx) => 
                  item.products ? item.products.map((product, pIdx) => (
                    <tr key={`${idx}-${pIdx}`} style={{
